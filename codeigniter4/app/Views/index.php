...
<html lang="en">
	...
	<head><base href="">
		...
		<!--Toastr-->
		<!-- Incluir jQuery (Requerido por Toastr) -->
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu-item">
								...
								<div class="menu-item">
									<a class="menu-link bg-light" href="http://localhost/codeigniter4/public/metronic"  style="border: 2px solid; margin-left: 10px; box-shadow: 3px 3px 3px black;">
    ...
    <!--begin::Navbar-->
    						<div class="d-flex align-items-stretch" id="kt_header_nav">
        						...
        						<div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
            						<!--begin::Menu-->
           						 <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1" style="margin-left: 15px;">Dashboard</h1>
           						 <!--end::Title-->
           						 <!--begin::Separator-->
           						 <!--end::Menu-->
        						</div>
									...
									<div class="col-xxl-4">
										...
										<div class="card card-xxl-stretch">
											...
											<div class="card-header border-0 bg-danger py-5">
												<h3 class="card-title fw-bolder text-white" style="height: 100px; margin-bottom: 20px;">Current hyperloop pathway jumps</h3>
											...
											<div class="card-body p-0">
												<!--begin::Chart-->
												<div class="mixed-widget-2 card-rounded-bottom bg-danger" data-kt-color="danger" style="height: 200px" id="chart4"></div>
												<!--end::Chart-->
												<!--begin::Stats-->
												<div class="card-p mt-n20 position-relative">
													...
													<div class="row g-0">
														...
														<div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
															...
															<!--end::Svg Icon-->
															<a href="<?= base_url('metronic/news'); ?>" class="text-warning fw-bold fs-6">Our news</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
															...
															<!--end::Svg Icon-->
															<a href="<?= base_url('metronic/roles'); ?>" class="text-primary fw-bold fs-6">Our roles & positions</a>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
													...
													<div class="row g-0">
														...
														<div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
															...
															<!--end::Svg Icon-->
															<a href="<?= base_url('metronic/timezone'); ?>" class="text-danger fw-bold fs-6 mt-2">Timezones</a>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col bg-light-success px-6 py-8 rounded-2">
															...
															<!--end::Svg Icon-->
															<a href="<?= base_url('metronic/userlist'); ?>" class="text-success fw-bold fs-6 mt-2">Our team</a>
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
										...
										<div class="card card-xxl-stretch">
											...
											<div class="card-header align-items-center border-0 mt-4">
												<h3 class="card-title align-items-start flex-column">
													...
													<span class="text-muted fw-bold fs-7">How to write</span>
												</h3>
												<div class="card-toolbar">
													<!--begin::Menu-->
											...
											<div class="card-body pt-5">
												...
												<div class="timeline-label">
													...
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="fw-mormal timeline-content text-muted ps-3">Go to the grand Station</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														...
														<div class="timeline-content d-flex">
															<span class="fw-bolder text-gray-800 ps-3">Transbord the hyperloop and fit the strap above yourself</span>
														</div>
														<!--end::Content-->
													</div>
													<!--end::Item-->
													...
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content fw-bolder text-gray-800 ps-3">get down
														<a href="#" class="text-primary">on your respective timezone</a>, DO NOT MISS</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content fw-mormal text-muted ps-3">Fit your designated costme and blend in</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content fw-bold text-gray-800 ps-3">Write and blend in until next day
														<a href="#" class="text-primary">Find a hotel or inn</a>.</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content fw-mormal text-muted ps-3">Keep writing until 21:03</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Desc-->
														<div class="timeline-content fw-bold text-gray-800 ps-3">Get on the Hyperloop and fit the strap
														<a href="#" class="text-primary">It needs to have "Back" on the front</a>.</div>
														<!--end::Desc-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="timeline-item">
														...
														<!--end::Badge-->
														<!--begin::Text-->
														<div class="timeline-content fw-mormal text-muted ps-3">Clock out, you can return home</div>
														<!--end::Text-->
													</div>
													<!--end::Item-->
												</div>
									...
									<div class="col-xxl-4">
										...
										<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
											...
											<div class="card-body d-flex flex-column p-0">
												...
												<!--end::Stats-->
												<!--begin::Chart-->
												<div id="chart1" class="mixed-widget-7-chart card-rounded-bottom" style="height: 150px"></div>
										...
										<div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
											...
											<div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden">
												...
												<!--end::Hidden-->
												<!--begin::Chart-->
												<div class="mixed-widget-10-chart" data-kt-color="primary" style="height: 150px" id="chart3"></div>
												<!--end::Chart-->
											</div>
										</div>
										<!--end::Mixed Widget 10-->
...
<br>
    ...
    <div class="card-body d-flex flex-column">
        <!--begin::Chart-->
        <div id="chart2" class="mixed-widget-chart card-rounded-top" style="height: 150px;"></div>
        <!--end::Chart-->
    </div>
    <!--end::Body-->
</div>
 ...
 var options4 = {
        ...
        xaxis: {
            categories: ["Anc", "Mid", "Mod", "Cont", "P-G"]
        },
        colors: ["#fff"], // White bars for better contrast
        plotOptions: {
            bar: {
                borderRadius: 4,
                horizontal: false,
