    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: function(fetchInfo, successCallback, failureCallback) {
                $.ajax({
                    url: "<?= site_url('calendar/events/fetchEvents'); ?>",
                    method: "GET",
                    dataType: "json",
            ...
            select: function(info) {
                ...
                if (title) {
                    $.ajax({
                        url: "<?= site_url('calendar/events/addEvent'); ?>",
                        method: "POST",
                        data: {
                            title: title,
                            start: info.startStr,
            ...
            eventClick: function(info) {
                if (confirm("¿Deseas eliminar este evento?")) {
                    $.ajax({
                        url: "<?= site_url('calendar/events/deleteEvent'); ?>/" + info.event.id,
                        method: "POST",
                        dataType: "json",
                        success: function(response) {
                            if (response.status === 'success') {
                                info.event.remove(); // Eliminar visualmente el evento
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">The Clock</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
