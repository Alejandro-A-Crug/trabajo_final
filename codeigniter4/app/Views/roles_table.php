...
<?php else: ?>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
													...
													<select id="privileges" name="privileges" class="form-control">
														...
														<option value="Admin">Admin</option>
															...
															<!--end::Options-->
															<br>
													<label for="deletion" class="form-label">Deletion</label>	
            										<select id="deletion" name="deletion" class="form-control">
           											 	<option value="">All</option>
               											 <option value="Null">Active</option>
               											 <option value="Not_Null">Archived</option>
           											</select>
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('metronic/roles/export') ?>" type="button" class="btn btn-light-primary me-3">
												...
												<!--end::Export-->
												<!--begin::Add customer-->
												<a href="<?= base_url('metronic/roles/create') ?>"><button type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
    ...
    <a href="<?= base_url('metronic/roles?' . http_build_query(array_merge($request, ['order_by' => 'Name', 'order_direction' => ($currentOrderBy === 'Name' && $currentOrderDirection === 'ASC' ? 'DESC' : 'ASC')]))) ?>">
        Name <?= $currentOrderBy === 'Name' ? ($currentOrderDirection === 'ASC' ? '↑' : '↓') : '' ?>
    </a>
</th>
<th class="min-w-125px">
    <a href="<?= base_url('metronic/roles?' . http_build_query(array_merge($request, ['order_by' => 'Privileges', 'order_direction' => ($currentOrderBy === 'Privileges' && $currentOrderDirection === 'ASC' ? 'DESC' : 'ASC')]))) ?>">
        Privileges <?= $currentOrderBy === 'Privileges' ? ($currentOrderDirection === 'ASC' ? '↑' : '↓') : '' ?>
    </a>
</th>
        ...
        <?php foreach ($roles as $role): ?>
			...
			<td class="text-end">
						...
						<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
							...
							<div class="menu-item px-3">
								<a href="<?= base_url('metronic/roles/create/' . $role['id']) ?>" class="menu-link px-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
							...
							<!--begin::Menu item-->
							<div class="menu-item px-3">
								<a href="<?= base_url('metronic/roles/delete/' . esc($role['id'])) ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
...
<div class="mt-4 d-flex justify-content-end">
    <?= $pager->links('default', 'custom_pagination') ?>
					...
					<!--end::Content-->
					<!--begin::Footer-->
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer" style="margin-top: 20px;">
						<!--begin::Container-->
