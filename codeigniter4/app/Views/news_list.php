					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu-item">
								...
								<div class="menu-item bg-light" style="border: 2px solid; margin-left: 10px; box-shadow: 3px 3px 3px black;">
    ...
    <!--begin::Navbar-->
    						<div class="d-flex align-items-stretch" id="kt_header_nav">
        						...
        						<div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
            						<!--begin::Menu-->
           						 <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">News</h1>
           						 <!--end::Title-->
           						 <!--begin::Separator-->
           						 <!--end::Menu-->
        						</div>
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
													...
													<div class="px-7 py-5">
														...
														<div class="mb-10">
															<!--begin::Label-->
															<label class="form-label fs-5 fw-bold mb-3">Title:</label>
															<!--end::Label-->
															<!--begin::Input-->
														...
														<div class="mb-10">
															<!--begin::Label-->
															<label class="form-label fs-5 fw-bold mb-3">Age:</label>
															<!--end::Label-->
															<!--begin::Options-->
															<select class="form-select" aria-label="Default select example" name="Age">
  															<option selected value="">All</option>
  															<option value="Prehistory">Prehistory</option>
  															<option value="Ancient">Ancient Age</option>
  															<option value="Middle">Middle Age</option>
															<option value="Modern">Modern Age</option>
															<option value="Contemporary">Contemporary Age</option>
															<option value="PostContemporary">Post-Contemporary Age</option>
															<option value="PostDivine">Post-Divine Age</option>
															<option value="Final">Final Age</option>
															</select>
															<!--end::Options-->
														</div>
														<!--end::Input group-->
														...
														<div class="mb-10">
														<!--begin::Label-->
														<label class="form-label fs-5 fw-bold mb-3">Controversy</label>
															<!--end::Label-->
															<!--begin::Options-->
															<select class="form-select" aria-label="Default select example" name="Controversy">
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('metronic/news/export') ?>" type="button" class="btn btn-light-primary me-3">
												...
												<!--end::Export-->
												<!--begin::Add customer-->
												<a href="<?= base_url('metronic/news/save') ?>" type="button" class="btn btn-primary" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
...
<th class="min-w-125px">
    <a href="<?= base_url('metronic/news?' . http_build_query(array_merge($request, ['orderBy' => 'Year', 'orderDirection' => ($orderBy === 'Year' && $orderDirection === 'asc' ? 'desc' : 'asc')]))) ?>">
        Year <?= $orderBy === 'Year' ? ($orderDirection === 'asc' ? '↑' : '↓') : '' ?>
    </a>
</th>
<th class="min-w-125px">
    <a href="<?= base_url('metronic/news?' . http_build_query(array_merge($request, ['orderBy' => 'Level_Controversy', 'orderDirection' => ($orderBy === 'Level_Controversy' && $orderDirection === 'asc' ? 'desc' : 'asc')]))) ?>">
        Level of Controversy <?= $orderBy === 'Level_Controversy' ? ($orderDirection === 'asc' ? '↑' : '↓') : '' ?>
    </a>
</th>
