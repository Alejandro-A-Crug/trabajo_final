...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" href="<?= base_url('logos/goldfish.png'); ?>" /> <!-- Use base_url() -->
    ...
    <link href="<?= base_url('assets/plugins/custom/fullcalendar/fullcalendar.bundle.css'); ?>" rel="stylesheet" type="text/css" /> <!-- Use base_url() -->
    <!--end::Page Vendor Stylesheets-->
    
    <!--begin::Global Stylesheets Bundle (used by all pages)-->
    <link href="<?= base_url('assets/plugins/global/plugins.bundle.css'); ?>" rel="stylesheet" type="text/css" /> <!-- Use base_url() -->
    <link href="<?= base_url('assets/css/style.bundle.css'); ?>" rel="stylesheet" type="text/css" /> <!-- Use base_url() -->
				...
				<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu-item">
								...
								<div class="menu-item">
									<a class="menu-link active" href="http://localhost/codeigniter4/public/metronic">
								...
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
											<a class="menu-link" href="<?= base_url('metronic/userlist'); ?>">
										...
										<?php $session = session(); ?>
											<div class="menu-item">
   											 <a class="menu-link" href="<?= base_url($session->has('id') ? 'metronic/logout' : 'metronic/login') ?>">
        											<span class="menu-bullet">
            											<span class="bullet bullet-dot"></span>
        											</span>
        											<span class="menu-title">
           											 <?= $session->has('id') ? 'Log Out' : 'Log In' ?>
       											 </span>
    											</a>
											</div>

										<div class="menu-item">
											<a class="menu-link" href="<?= base_url('metronic/users/saveuser') ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
								...
								<span class="menu-link ">
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										<div class="menu-item">
										<a class="menu-link" href="<?= base_url('metronic/roles'); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
								...
								<div class="menu-item">
									<div class="menu-content pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">Time</span>
									</div>
								</div>

								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									<span class="menu-link bg-light" style="border: 2px solid; margin-left: 10px; box-shadow: 3px 3px 3px black;">
										<span class="menu-icon">
									...
									<div class="menu-item">
											<a class="menu-link" href="<?= base_url('metronic/timezone'); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
												<span class="menu-title">List</span>
								...
								<div class="menu-item">
									<div class="menu-content pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">News</span>
									</div>
								</div>
								<div class="menu-item">
									<a class="menu-link" href="<?= base_url('metronic/news'); ?>">
										<span class="menu-icon">
					...
					<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
												<img src="<?= base_url('logos/clock_user_white.png'); ?>" alt="user" />
											</div>
											<!--begin::Menu-->
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<div class="menu-content d-flex align-items-center px-3">
														...
														<div class="symbol symbol-50px me-5">
															<img alt="Logo" src="<?= base_url('logos/clock_user_transp.png'); ?>" />
														</div>
														<!--end::Avatar-->
														<!--begin::Username-->
														<div class="d-flex flex-column">
															<div class="fw-bolder d-flex align-items-center fs-5"><?= esc($session->get('nombre') ?: 'Guest'); ?>
															</div>
															<div class="fw-bold d-flex align-items-center fs-7"><?= esc($session->get('rol') ?: 'Reader'); ?>
															</div>
														</div>
														<!--end::Username-->
													</div>
												...
												<div class="menu-item px-5">
													<div><?= esc($session->get('id') ?: '??'); ?></div>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-5">
													<div><?= esc($session->get('timezone') ?: '2025'); ?></div>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												...
												<?php $session = session(); ?>
    												...
    												<div><a href="<?= base_url('metronic/users/viewSession'); ?>">My Profile</a></div>
													<?php endif; ?>
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
								...
								<img alt="Logo" src="<?= base_url("logos/The Clock_Black.png"); ?>" class="h-50px" />
								</a>
							</div>
							<!--end::Mobile logo-->
							<!--begin::Wrapper-->
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
													...
													<div class="px-7 py-5">
  													...
  													<input type="number" class="form-control" id="IdInput" name="IdInput" placeholder="">
													</div>
													<div class="mb-3">
  													<label for="YearInput" class="form-label">Year</label>
													  <select class="form-select form-select-lg mb-3" aria-label="Large select example" id="YearInput" name="YearInput">
  														<option selected value="">All</option>
  														<option value="before"><?= isset($_GET['epoca']) && $_GET['epoca'] == 'before' ? 'selected' : '' ?>Before <?= date('Y') ?> </option>
  														<option value="after"><?= isset($_GET['epoca']) && $_GET['epoca'] == 'before' ? 'selected' : '' ?>After <?= date('Y') ?></option>
													  </select>
													</div>
													<div class="mb-3">
  													<label for="AgeInput" class="form-label">Age</label>
  													<input type="text" class="form-control" id="AgeInput" name="AgeInput" placeholder="the 80s">
													</div>
													<div class="mb-3">
  													<label for="SE_Input" class="form-label">Significant Event</label>
  													<input type="text" class="form-control" id="SE_Input" name="SE_Input" placeholder="The Bite of 87">
													</div>
													<div class="mb-3">
  													<label for="DeleteInput" class="form-label">Deleted</label>
													  <select class="form-select form-select-lg mb-3" aria-label="Large select example" id="DeleteInput" name="DeleteInput">
  														<option selected value="">All</option>
  														<option value="NULL">Active </option>
  														<option value="NOT_NULL">Not Active</option>
													  </select>
													</div>
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('metronic/timezones/export') ?>" type="button" class="btn btn-light-primary me-3">
												...
												<!--end::Export-->
												<!--begin::Add customer-->
												<a href="<?= base_url('metronic/timezone/create') ?>"><button type="button" class="btn btn-primary">
...
<th class="min-w-125px">
    <a href="<?= base_url('metronic/timezone?' . http_build_query(array_merge($request, ['orderBy' => 'Age', 'orderDirection' => ($orderBy === 'Age' && $orderDirection === 'asc' ? 'desc' : 'asc')]))) ?>">
        Age <?= $orderBy === 'Age' ? ($orderDirection === 'asc' ? '↑' : '↓') : '' ?>
    </a>
</th>
<th class="min-w-125px">
    <a href="<?= base_url('metronic/timezone?' . http_build_query(array_merge($request, ['orderBy' => 'Significant_Event', 'orderDirection' => ($orderBy === 'Significant_Event' && $orderDirection === 'asc' ? 'desc' : 'asc')]))) ?>">
        Significant Event <?= $orderBy === 'Significant_Event' ? ($orderDirection === 'asc' ? '↑' : '↓') : '' ?>
    </a>
</th>
												...
												<?php foreach($ages as $age): ?>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<?php 
													$session = session(); 
													$allowedRoles = ['General Director', 'Journalist', 'Cleaner']; // Roles permitidos
																?>
																<?php if ($session->get('isLoggedIn') && in_array($session->get('rol'), $allowedRoles)): ?>
															<div class="menu-item px-3">
																<a href="<?= base_url('metronic/timezone/create/' . $age['id']) ?>" class="menu-link px-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
															...
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?=base_url('metronic/timezone/deleteAge/') . esc($age['id']) ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
