												...
												<tr <?= $user['borrado_en'] ? 'style="background-color: #bb3c36; color: white;"' : '' ?>>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?= base_url('metronic/users/saveuser/' . $user['id']) ?>" class="menu-link px-3"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
															...
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="<?=base_url('metronic/users/deleteuser/') . esc($user['id']) ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
