...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" href="<?= base_url('logos/goldfish.png'); ?>"/> 
...
<?php else: ?>
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" id="kt-toolbar-filter">
													...
													<!--begin::Content-->
													<form class="">
            										<div class="container-fluid custom" style="padding: 20px">
															<label for="nombre" class="form-label">Name</label>
           													 <input type="text" name="nombre" class="form-control">
															 <br>
															 <label for="epoca" class="form-label">Subjective time Placement</label>
                										...
                										<option value="after" <?= isset($_GET['epoca']) && $_GET['epoca'] == 'after' ? 'selected' : '' ?>>After <?= date('Y') ?></option>
           												 </select>
														 <br>
														 <label for="rol" class="form-label">Role</label>
            											<input type="text" name="rol" placeholder="Role" class="form-control">
														<br>
														<label for="borrado_en" class="form-label">Deletion</label>
            										<select id="borrado_en" name="borrado_en" class="form-control">
           											 <option value="">All</option>
												...
												<!--end::Filter-->
												<!--begin::Export-->
												<a href="<?= base_url('metronic/users/export') ?>" type="button" class="btn btn-light-primary me-3">
												...
												<!--end::Export-->
												<!--begin::Add customer-->
												<a href="<?= base_url('metronic/users/saveuser') ?>"><button type="button" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
    ...
    <a href="<?= base_url('metronic/userlist?' . http_build_query(array_merge($request, ['orderBy' => 'nombre', 'orderDirection' => ($orderBy === 'nombre' && $orderDirection === 'asc' ? 'desc' : 'asc')]))) ?>">
...
<th class="min-w-125px">
    <a href="<?= base_url('metronic/userlist?' . http_build_query(array_merge($request, ['orderBy' => 'rol', 'orderDirection' => ($orderBy === 'rol' && $orderDirection === 'asc' ? 'desc' : 'asc')]))) ?>">
        Role <?= $orderBy === 'rol' ? ($orderDirection === 'asc' ? '↑' : '↓') : '' ?>
    </a>
</th>
        <th class="text-end min-w-70px">Actions</th>
											...
											<?php foreach ($users as $user): ?>
												<tr>
													...
													<!--begin::Name=-->
													<td>
													<a href="<?= base_url('metronic/users/view/' . $user['id']) ?>" class="text-gray-800 text-hover-primary mb-1" 
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="<?= base_url('metronic/users/saveuser/' . $user['id']) ?>" class="menu-link px-3">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="<?= base_url('metronic/users/deleteuser/') . esc($user['id']) ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row">
