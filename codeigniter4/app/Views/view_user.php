									...
									<div class="flex-column flex-lg-row-auto w-100 w-xl-350px mb-10">
										...
										<div class="card mb-5 mb-xl-8">
											...
											<div class="card-body">
												...
												<div class="badge badge-lg badge-light-secondary d-inline text-end" style="<?= $user['borrado_en'] ? 'background-color: #ff3930;' : 'background-color: #9dff70;' ?>"><?= $user['borrado_en'] ? 'Deleted' : 'Active' ?></div>
												<!--begin::User Info-->
												<div class="d-flex flex-center flex-column py-5">
													...
													<!--end::Avatar-->
													<!--begin::Name-->
													<a href="#" class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3"><?= esc($user['nombre']) ?></a>
													<!--end::Name-->
													<!--begin::Position-->
													<div class="mb-9">
														<!--begin::Badge-->
														<div class="badge badge-lg badge-light-primary d-inline"><?= esc($user['rol']) ?></div>
														<!--begin::Badge-->
													</div>
													<!--end::Position-->
													<!--begin::Info-->
												...
												<div class="d-flex flex-stack fs-4 py-3">
													...
													<span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit & Delete">
														<a href="<?= base_url('metronic/users/saveuser/' . $user['id']) ?>" class="btn btn-sm btn-light-primary">Edit user</a>
														<a href="<?=base_url('metronic/users/deleteuser/') . esc($user['id']) ?>" class="btn btn-sm btn-light-danger">Delete user</a>
													</span>
												</div>
												<!--end::Details toggle-->
												...
												<div id="kt_user_view_details" class="collapse show">
													<div class="pb-5 fs-6">
														...
														<div class="text-gray-600">ID-<?= esc($user['id']) ?></div>
														<!--begin::Details item-->
														<!--begin::Details item-->
														<div class="fw-bolder mt-5">Timezone</div>
														<div class="text-gray-600">
															<a href="#" class="text-gray-600 text-hover-primary"><?= esc($user['epoca']) ?></a>
														</div>
														<!--begin::Details item-->
														<!--begin::Details item-->
												...
												<div class="card card-flush mb-6 mb-xl-9">
													...
													<div class="card-header mt-6">
														...
														<div class="card-title flex-column">
															<h2 class="mb-1"><?= esc($user['nombre']) ?>'s Rules</h2>
															<div class="fs-6 fw-bold text-muted">Eveyrone in the clock follows the same rules</div>
														</div>
														<!--end::Card title-->
														<!--begin::Card toolbar-->
													...
													<div class="card-body d-flex flex-column">
														...
														<div class="d-flex align-items-center position-relative mb-7">
															...
															<div class="fw-bold ms-5">
																<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Arrive on time, time being 7:31</a>
																<!--begin::Info-->
																<div class="fs-7 text-muted">NEVER ARRIVE EARLY
																<a href="#">7:31</a></div>
																<!--end::Info-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex align-items-center position-relative mb-7">
															...
															<!--begin::Details-->
															<div class="fw-bold ms-5">
																<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Get a nice breakfast</a>
																<!--begin::Info-->
																<div class="fs-7 text-muted">We offer various kinds of options
																<a href="#">7:35-8:34</a></div>
																<!--end::Info-->
															</div>
															<!--end::Details-->
															<!--begin::Menu-->
														...
														<div class="d-flex align-items-center position-relative mb-7">
															...
															<!--begin::Details-->
															<div class="fw-bold ms-5">
																<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Get to the workstation</a>
																<!--begin::Info-->
																<div class="fs-7 text-muted">And start your shift
																<a href="#">8:38</a></div>
																<!--end::Info-->
															</div>
															<!--end::Details-->
														...
														<div class="d-flex align-items-center position-relative mb-7">
															...
															<!--begin::Details-->
															<div class="fw-bold ms-5">
																<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Be mindful of your articles</a>
																<!--begin::Info-->
																<div class="fs-7 text-muted">and the portrayal of time during your shift
																<a href="#">8:38-18:38</a></div>
																<!--end::Info-->
															</div>
															<!--end::Details-->
															<!--begin::Menu-->
														...
														<div class="d-flex align-items-center position-relative">
															...
															<!--begin::Details-->
															<div class="fw-bold ms-5">
																<a href="#" class="fs-5 fw-bolder text-dark text-hover-primary">Leave as fas as you can</a>
																<!--begin::Info-->
																<div class="fs-7 text-muted">You must 
																<a href="#">leave before 21:30</a></div>
																<!--end::Info-->
															</div>
															<!--end::Details-->
															<!--begin::Menu-->
