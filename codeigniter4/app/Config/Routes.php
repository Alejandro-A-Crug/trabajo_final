...
$routes->get('metronic/users/view/(:num)', 'UserController_M::visualize/$1');
$routes->get('metronic/users/viewSession', 'UserController_M::visualizeSession');
...
$routes->get('metronic/users/export', 'ExportController::exportUsers');
$routes->get('metronic/timezones/export', 'ExportController::exportTimezones');
$routes->get('metronic/roles/export', 'ExportController::exportRoles');
$routes->get('metronic/news/export', 'ExportController::exportNews');
