...
public function deleteUser($id){
    ...
    return redirect()->to('/metronic/userlist')->with('success','persona archivada con éxito');
...
return redirect()->to('metronic/login')->with('error', 'Correo o contraseña incorrectos.');
}
...
public function logout()
{
    $session = session();
    $session->destroy();
    return redirect()->to('metronic/login')->with('success', 'Sesión cerrada con éxito.');
}
